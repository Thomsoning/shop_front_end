...
/* 4 */
/*!*******************************************************!*\
  !*** D:/VueProject/uni-app/shop_front_end/pages.json ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 7 */
/*!************************************************************************!*\
  !*** D:/VueProject/uni-app/shop_front_end/pages.json?{"type":"style"} ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 8 */
/*!***********************************************************************!*\
  !*** D:/VueProject/uni-app/shop_front_end/pages.json?{"type":"stat"} ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 9 */
/*!***********************************************************!*\
  !*** D:/VueProject/uni-app/shop_front_end/store/index.js ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/**
                   * 查询模块
                   */
var modulesContext = __webpack_require__(11);
...
function createStoreModules(fileArr) {
  fileArr.keys().forEach(function (element) {
...
/* 11 */
/*!*********************************************************************!*\
  !*** D:/VueProject/uni-app/shop_front_end/store/modules sync \.js$ ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var mutations = {
  getProList: function getProList(state, result) {
    result.data.data.list.forEach(function (element) {
      element.productInfo = JSON.parse(element.productInfo);
    });
  ...
  addProduct: function addProduct(state, result) {
    state.addProduct = result.data.data;
  },


  getCartList: function getCartList(state, result) {
...
var actions = {
  getProList: function getProList(_ref, params) {var state = _ref.state,commit = _ref.commit;
    console.log("商品列表入参", params);
    var res = _config.default.list(params);
    Promise.resolve(res).then(function (result) {var _result = _slicedToArray(
      result, 2),errmsg = _result[0],res = _result[1];
  ...
  addProduct: function addProduct(_ref2, params) {var state = _ref2.state,commit = _ref2.commit;
    console.log("添加商品入参", params);
    var res = _config.default.add(params);
    Promise.resolve(res).then(function (result) {var _result2 = _slicedToArray(
      result, 2),errmsg = _result2[0],res = _result2[1];
  ...
  delete: function _delete(_ref3, params) {var state = _ref3.state,commit = _ref3.commit;
    console.log("删除商品入参", params);
    var res = _config.default.delete(params);
    Promise.resolve(res).then(function (result) {
      params.productId = '';
      var res = _config.default.list(params);
      Promise.resolve(res).then(function (result) {
  ...
  update: function update(_ref4, params) {var state = _ref4.state,commit = _ref4.commit;
    console.log("修改商品入参", params);
    var res = _config.default.update(params);
    Promise.resolve(res).then(function (result) {
      params.productId = '';
      params.productName = '';
      var res = _config.default.list(params);
  ...
  getCartList: function getCartList(_ref5, params) {var state = _ref5.state,commit = _ref5.commit;
    console.log("购物车列表入参", params);
    var res = _config.default.cartList(params);
    Promise.resolve(res).then(function (result) {var _result3 = _slicedToArray(
      result, 2),errmsg = _result3[0],res = _result3[1];
...

{
  ...
  image3: "http://49.233.188.52:8888/group1/M00/00/00/Mem8NF_4aPCANkrOAAPl4hnqKs8485.jpg",
